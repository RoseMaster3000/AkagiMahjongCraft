...
class DiceEntity(
    ...
    /**
     * The current point of the dice (related to its orientation)
     * */
    var point: DicePoint
    ...
    override fun interact(player: PlayerEntity, hand: Hand): ActionResult {
        if (!player.world.isClient) {
            ...
            if (!isSpawnedByGame && player.isSneaking) { // Not generated by the game, it's a normal entity placed manually
                // Can only pick up the dice while sneaking
    ...
    override fun tick() {
        ...
        ++age
        if (rolling) { // The dice is rolling
    ...
    override fun readCustomDataFromNbt(nbt: NbtCompound) {
        ...
        // Avoids dice summoned by commands without NBT, which would prevent them from being summoned
